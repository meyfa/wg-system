...
export default function BasicButton (props: PropsWithChildren<Props>): ReactElement {
  return (
    <button
      type='button'
      className={clsx(
        'inline-block h-9 px-2.5 mx-1 first:ml-0 last:mr-0 text-sm font-bold uppercase bg-white border border-gray-400 rounded-md cursor-pointer outline-none shadow-md',
